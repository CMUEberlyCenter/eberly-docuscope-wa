...
import { Button, Card, Col, Container, ListGroup, Modal, ModalProps, Row, Stack } from "react-bootstrap";
...
const SelectExpectation: FC<SelectExpectationProps> = ({ onHide, select, ...props }) => {
