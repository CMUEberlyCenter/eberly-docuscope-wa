...
import { taggerResults$, TaggerResults, isTaggerResult, gen_patterns_map } from './tagger.service';
...
describe('tagger.service', () => {
  test('tagText error', async () => {
    taggerResults$.pipe(first()).subscribe((res) => expect(res, 'Initial value').toBe(null));
