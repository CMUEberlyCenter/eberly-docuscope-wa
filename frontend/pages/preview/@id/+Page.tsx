...
import { Alert, ButtonGroup, ButtonToolbar, Dropdown, OverlayTrigger, Placeholder, Stack, Tab, Tabs, Tooltip } from "react-bootstrap";
...
import { CivilTone } from "../../../src/app/components/Review/CivilTone";
        ...
        >
          <div className="h-100 d-flex flex-column overflow-auto">
            ...
            >
              ...
              {/* )} */}
              {secondaryTool === "organization" && <Organization />}
              {secondaryTool === "sentence_density" && <Sentences />}
              {secondaryTool === "paragraph_clarity" && <ParagraphClarity />}
              {secondaryTool === "professional_tone" && <ProfessionalTone />}
              {secondaryTool === "sources" && <Sources />}
